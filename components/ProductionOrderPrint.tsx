        ...
        <div className="flex border border-black">
          ...
          <div className="w-2/3 border-r border-black">
            ...
            <div className="p-1 grid grid-cols-2 gap-x-2 text-[10px]">
              ...
              <div className="flex justify-end"><span className="mr-2">วันที่ออกเอกสาร</span> <span>{new Date().toLocaleString('th-TH', { day: 'numeric', month: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric' })}</span></div>
